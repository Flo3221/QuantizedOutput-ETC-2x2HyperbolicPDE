...
**"Output Quantization Compensation in Event-Triggered Backstepping Control of 2×2 Hyperbolic Systems"** ([submitted](https://hal.science/hal-05570991/)).
...
For detailed equations, backstepping kernel derivations, stability results, and parameter choices, please refer to the associated paper and ([mathematical details](https://tucgr-my.sharepoint.com/:b:/g/personal/fkoudohode_tuc_gr/IQAnmUwTMskQR7sLvugJRk1HAQzCIN3-kZRSwvUzMp7zKG8?e=mLIEa1)).
